    ...
    constructor(parameters, table) {
        ...
        */
        ...
        /* To-do #2 - Create the racket (a rectangle) with properties defined by the following parameters:
            ...
            - follow the instructions in this example to create the rectangle: https://threejs.org/docs/ap  i/en/geometries/PlaneGeometry.html
        */
    ...
    */
    checkLowerBoundary() {
        if (this.center.y < this.centerLower) {
            this.position.set(this.center.x, this.centerLower);;
        }
    }

    checkUpperBoundary() {
        if (this.center.y > this.centerUpper) {
            this.position.set(this.center.x, this.centerUpper);;
        }
    } 
